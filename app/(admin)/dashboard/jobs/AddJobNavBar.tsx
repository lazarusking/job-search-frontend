  ...
  return (
    <div className="py-4 px-6 bg-white">
      <div className="flex flex-wrap items-center">
        <div className="w-full sm:w-auto flex items-center mb-5 lg:mb-0">
          ...
          <div>
            <h2 className="mb-1 text-2xl font-bold">Jobs</h2>
            <p className="text-sm text-gray-500 font-medium">
              <span className="text-indigo-500 text-lg space-x-1">
                {count} Active Jobs
              </span>
            </p>
          </div>
        </div>
        <div className="w-full md:w-1/2 lg:w-auto flex pr-4 mb-4 md:mb-0 md:mr-4 md:ml-auto rounded bg-white">
          <label className="relative">
            <input
              className="py-2 pl-4 pr-2 text-sm placeholder-gray-500 p-2 border border-gray-300"
              type="text"
            ...
            <button
              ...
              className="absolute inset-y-0 right-1 ml-auto focus:ring-blue-400"
            >
              <svg
                width={20}
                height={20}
