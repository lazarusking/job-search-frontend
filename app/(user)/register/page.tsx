        ...
        <div className="flex flex-col md:col-span-7 w-full mx-auto justify-center items-center ">
          ...
          >
            ...
            <div className="col-span-6 grid justify-center sm:flex sm:items-center sm:gap-4">
              <button className="inline-flex shrink-0 rounded-md border border-blue-600 bg-blue-600 px-12 py-3 text-sm font-medium text-white transition hover:bg-transparent hover:text-blue-600 focus:outline-none focus:ring active:text-blue-500">
                <svg
                  className={`${
