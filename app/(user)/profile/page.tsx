...
export default function Profile() {
  ...
  const [error, setErrorMessage] = useState<Partial<UserProfile>>({});
      ...
      <div className="container px-4 mx-auto">
        ...
        >
          ...
          {error.user?.first_name && (
            <ErrorMessage msg={error.user.first_name} />
          )}
          {error.user?.last_name && <ErrorMessage msg={error.user.last_name} />}
          ...
          />
          {error.date_of_birth && <ErrorMessage msg={error.date_of_birth} />}
          ...
          {error.gender && <ErrorMessage msg={error.gender} />}
          ...
          <ProfileInput title="Resume">
            <div className="w-full md:flex-1 p-3">
              ...
              <div className="relative flex flex-col items-center justify-center p-6 h-44 text-center text-green-500 focus-within:border-green-500 border border-dashed border-gray-200 rounded-lg">
                ...
                />
                {error.resume && <ErrorMessage msg={error.resume} />}
              </div>
            </div>
          </ProfileInput>
