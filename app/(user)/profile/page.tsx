        ...
        >
            ...
            <div className="w-full md:w-9/12">
              <div className="flex flex-wrap -m-3">
                ...
                <div className="w-full md:w-auto p-3">
                  <img
                    src="https://shuffle.dev/flex-ui-assets/images/dashboard/forms/avatar.png"
                    alt="Avatar"
                  />
                </div>
          ...
          <div className="py-6 border-b border-gray-100">
            <div className="w-full md:w-9/12">
              <div className="flex flex-wrap -m-3">
                <div className="w-full md:w-1/3 p-3">
                  <p className="text-sm text-gray-800 font-semibold">Country</p>
                </div>
                <div className="w-full md:flex-1 p-3">
          ...
          <div className="py-6 border-b border-gray-100">
            <div className="w-full md:w-9/12">
              <div className="flex flex-wrap -m-3">
                <div className="w-full md:w-1/3 p-3">
                  <p className="text-sm text-gray-800 font-semibold">Domain</p>
                </div>
                <div className="w-full md:flex-1 p-3">
