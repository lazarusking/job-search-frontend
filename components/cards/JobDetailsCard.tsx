          ...
          <div className="relative flex items-center">
            {user_count ? (
              <>
                ...
                />
                <div className="inline-flex ml-2 items-center justify-center text-xs font-medium text-indigo-500">
                  {user_count}
                </div>
              </>
            ) : (
          ...
          {new_users ? (
            <div className="flex text-sm">
              ...
              <UserPlusIcon
                ...
                className="w-5 h-5 text-gray-600"
              />
              <h3 className="inline-flex ml-1 items-center justify-center text-xs font-medium text-gray-400">
                {new_users}
              </h3>
            </div>
          ) : (
