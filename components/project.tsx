    ...
    <div className="flex flex-wrap -mx-3 -mb-8">
        ...
        <div className="max-w-sm mx-auto h-full px-4 pt-6 pb-24 bg-gray-500 rounded-xl">
          <div className="flex items-center justify-between mb-3">
            <div className="flex items-center">
              ...
              <span className="inline-flex items-center justify-center w-6 h-7 rounded-full bg-gray-600 text-xs font-medium text-gray-400">
                3
              </span>
            </div>
            <div>
          ...
          <div className="h-1 w-full mb-4 rounded-full bg-purple-500" />
          <a
              ...
              <div className="flex flex-wrap items-center justify-between -m-2">
                ...
                <div className="w-auto p-2">
                  <div className="flex h-full items-center">
                    <img
                      className="w-7 h-7 rounded-full object-cover"
                      src="https://shuffle.dev/trizzle-assets/images/avatar-women-2-circle-border.png"
                      alt="Logo"
                    />
                    <img
                      className="w-7 h-7 -ml-3 rounded-full object-cover"
                      src="https://shuffle.dev/trizzle-assets/images/avatar-women-3-circle-border.png"
                      alt="Logo"
                    />
                  </div>
                </div>
          ...
          >
            ...
            <div className="flex items-center mb-4">
              <span className="h-2 w-2 mr-1 bg-purple-500 rounded-full" />
      ...
      <div className="w-full md:w-1/2 lg:w-1/4 px-3 mb-8">
        <div className="max-w-sm mx-auto h-full px-4 pt-6 pb-24 bg-gray-500 rounded-xl">
          <div className="flex items-center justify-between mb-3">
            <div className="flex items-center">
              <h3 className="text-lg text-white font-semibold mr-2">
                In progress
              </h3>
              <span className="inline-flex items-center justify-center w-6 h-7 rounded-full bg-gray-600 text-xs font-medium text-gray-400">
                2
          ...
          <div className="h-1 w-full mb-4 rounded-full bg-blue-500" />
          <a
            className="block p-4 mb-4 bg-gray-600 rounded-xl hover:bg-gray-700 transition duration-200"
            href="#"
          >
          ...
          >
            ...
            <img
              ...
              src="https://shuffle.dev/trizzle-assets/images/laptop-photo-placeholder.png"
              alt="Logo"
            />
      ...
      <div className="w-full md:w-1/2 lg:w-1/4 px-3 mb-8">
        <div className="max-w-sm mx-auto h-full px-4 pt-6 pb-24 bg-gray-500 rounded-xl">
          ...
          <div className="h-1 w-full mb-4 rounded-full bg-yellow-500" />
          <a
            className="block p-4 mb-4 bg-gray-600 rounded-xl hover:bg-gray-700 transition duration-200"
            href="#"
          >
          ...
          >
            <img
              className="block w-full h-28 object-cover rounded-md mb-3"
              src="https://shuffle.dev/trizzle-assets/images/working-women-laptop.png"
              alt="Logo"
            />
            <h4 className="text-white font-semibold leading-6 mb-1">
            ...
            <div className="flex items-center mb-4">
              <span className="h-2 w-2 mr-1 bg-blue-500 rounded-full" />
